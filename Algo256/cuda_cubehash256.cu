...
static __device__ __forceinline__ void rrounds(uint32_t x[2][2][2][2][2])
{
	...
	for(r = 0; r < CUBEHASH_ROUNDS; r += 2)
	{
		...
		x[0][0][0][0][0] = ROTATEUPWARDS7(x[0][0][0][0][0]) ^ x1[1][0][0][0];
		x[0][0][0][0][1] = ROTATEUPWARDS7(x[0][0][0][0][1]) ^ x1[1][0][0][1];
		x[0][0][0][1][0] = ROTATEUPWARDS7(x[0][0][0][1][0]) ^ x1[1][0][1][0];
		x[0][0][0][1][1] = ROTATEUPWARDS7(x[0][0][0][1][1]) ^ x1[1][0][1][1];
		x[0][0][1][0][0] = ROTATEUPWARDS7(x[0][0][1][0][0]) ^ x1[1][1][0][0];
		x[0][0][1][0][1] = ROTATEUPWARDS7(x[0][0][1][0][1]) ^ x1[1][1][0][1];
		x[0][0][1][1][0] = ROTATEUPWARDS7(x[0][0][1][1][0]) ^ x1[1][1][1][0];
		x[0][0][1][1][1] = ROTATEUPWARDS7(x[0][0][1][1][1]) ^ x1[1][1][1][1];
		x[0][1][0][0][0] = ROTATEUPWARDS7(x[0][1][0][0][0]) ^ x1[0][0][0][0];
		x[0][1][0][0][1] = ROTATEUPWARDS7(x[0][1][0][0][1]) ^ x1[0][0][0][1];
		x[0][1][0][1][0] = ROTATEUPWARDS7(x[0][1][0][1][0]) ^ x1[0][0][1][0];
		x[0][1][0][1][1] = ROTATEUPWARDS7(x[0][1][0][1][1]) ^ x1[0][0][1][1];
		x[0][1][1][0][0] = ROTATEUPWARDS7(x[0][1][1][0][0]) ^ x1[0][1][0][0];
		x[0][1][1][0][1] = ROTATEUPWARDS7(x[0][1][1][0][1]) ^ x1[0][1][0][1];
		x[0][1][1][1][0] = ROTATEUPWARDS7(x[0][1][1][1][0]) ^ x1[0][1][1][0];
		x[0][1][1][1][1] = ROTATEUPWARDS7(x[0][1][1][1][1]) ^ x1[0][1][1][1];
		...
		x[0][0][0][0][0] = ROTATEUPWARDS11(x[0][0][0][0][0]) ^ x[1][1][1][1][0];
		x[0][0][0][0][1] = ROTATEUPWARDS11(x[0][0][0][0][1]) ^ x[1][1][1][1][1];
		x[0][0][0][1][0] = ROTATEUPWARDS11(x[0][0][0][1][0]) ^ x[1][1][1][0][0];
		x[0][0][0][1][1] = ROTATEUPWARDS11(x[0][0][0][1][1]) ^ x[1][1][1][0][1];
		x[0][0][1][0][0] = ROTATEUPWARDS11(x[0][0][1][0][0]) ^ x[1][1][0][1][0];
		x[0][0][1][0][1] = ROTATEUPWARDS11(x[0][0][1][0][1]) ^ x[1][1][0][1][1];
		x[0][0][1][1][0] = ROTATEUPWARDS11(x[0][0][1][1][0]) ^ x[1][1][0][0][0];
		x[0][0][1][1][1] = ROTATEUPWARDS11(x[0][0][1][1][1]) ^ x[1][1][0][0][1];
		x[0][1][0][0][0] = ROTATEUPWARDS11(x[0][1][0][0][0]) ^ x[1][0][1][1][0];
		x[0][1][0][0][1] = ROTATEUPWARDS11(x[0][1][0][0][1]) ^ x[1][0][1][1][1];
		x[0][1][0][1][0] = ROTATEUPWARDS11(x[0][1][0][1][0]) ^ x[1][0][1][0][0];
		x[0][1][0][1][1] = ROTATEUPWARDS11(x[0][1][0][1][1]) ^ x[1][0][1][0][1];
		x[0][1][1][0][0] = ROTATEUPWARDS11(x[0][1][1][0][0]) ^ x[1][0][0][1][0];
		x[0][1][1][0][1] = ROTATEUPWARDS11(x[0][1][1][0][1]) ^ x[1][0][0][1][1];
		x[0][1][1][1][0] = ROTATEUPWARDS11(x[0][1][1][1][0]) ^ x[1][0][0][0][0];
		x[0][1][1][1][1] = ROTATEUPWARDS11(x[0][1][1][1][1]) ^ x[1][0][0][0][1];
		...
		x[0][0][0][0][0] = ROTATEUPWARDS7(x[0][0][0][0][0]) ^ x1[0][1][1][1];
		x[0][0][0][0][1] = ROTATEUPWARDS7(x[0][0][0][0][1]) ^ x1[0][1][1][0];
		x[0][0][0][1][0] = ROTATEUPWARDS7(x[0][0][0][1][0]) ^ x1[0][1][0][1];
		x[0][0][0][1][1] = ROTATEUPWARDS7(x[0][0][0][1][1]) ^ x1[0][1][0][0];
		x[0][0][1][0][0] = ROTATEUPWARDS7(x[0][0][1][0][0]) ^ x1[0][0][1][1];
		x[0][0][1][0][1] = ROTATEUPWARDS7(x[0][0][1][0][1]) ^ x1[0][0][1][0];
		x[0][0][1][1][0] = ROTATEUPWARDS7(x[0][0][1][1][0]) ^ x1[0][0][0][1];
		x[0][0][1][1][1] = ROTATEUPWARDS7(x[0][0][1][1][1]) ^ x1[0][0][0][0];
		x[0][1][0][0][0] = ROTATEUPWARDS7(x[0][1][0][0][0]) ^ x1[1][1][1][1];
		x[0][1][0][0][1] = ROTATEUPWARDS7(x[0][1][0][0][1]) ^ x1[1][1][1][0];
		x[0][1][0][1][0] = ROTATEUPWARDS7(x[0][1][0][1][0]) ^ x1[1][1][0][1];
		x[0][1][0][1][1] = ROTATEUPWARDS7(x[0][1][0][1][1]) ^ x1[1][1][0][0];
		x[0][1][1][0][0] = ROTATEUPWARDS7(x[0][1][1][0][0]) ^ x1[1][0][1][1];
		x[0][1][1][0][1] = ROTATEUPWARDS7(x[0][1][1][0][1]) ^ x1[1][0][1][0];
		x[0][1][1][1][0] = ROTATEUPWARDS7(x[0][1][1][1][0]) ^ x1[1][0][0][1];
		x[0][1][1][1][1] = ROTATEUPWARDS7(x[0][1][1][1][1]) ^ x1[1][0][0][0];
		...
		x[0][0][0][0][0] = ROTATEUPWARDS11(x[0][0][0][0][0]) ^ x[1][0][0][0][1];
		x[0][0][0][0][1] = ROTATEUPWARDS11(x[0][0][0][0][1]) ^ x[1][0][0][0][0];
		x[0][0][0][1][0] = ROTATEUPWARDS11(x[0][0][0][1][0]) ^ x[1][0][0][1][1];
		x[0][0][0][1][1] = ROTATEUPWARDS11(x[0][0][0][1][1]) ^ x[1][0][0][1][0];
		x[0][0][1][0][0] = ROTATEUPWARDS11(x[0][0][1][0][0]) ^ x[1][0][1][0][1];
		x[0][0][1][0][1] = ROTATEUPWARDS11(x[0][0][1][0][1]) ^ x[1][0][1][0][0];
		x[0][0][1][1][0] = ROTATEUPWARDS11(x[0][0][1][1][0]) ^ x[1][0][1][1][1];
		x[0][0][1][1][1] = ROTATEUPWARDS11(x[0][0][1][1][1]) ^ x[1][0][1][1][0];
		x[0][1][0][0][0] = ROTATEUPWARDS11(x[0][1][0][0][0]) ^ x[1][1][0][0][1];
		x[0][1][0][0][1] = ROTATEUPWARDS11(x[0][1][0][0][1]) ^ x[1][1][0][0][0];
		x[0][1][0][1][0] = ROTATEUPWARDS11(x[0][1][0][1][0]) ^ x[1][1][0][1][1];
		x[0][1][0][1][1] = ROTATEUPWARDS11(x[0][1][0][1][1]) ^ x[1][1][0][1][0];
		x[0][1][1][0][0] = ROTATEUPWARDS11(x[0][1][1][0][0]) ^ x[1][1][1][0][1];
		x[0][1][1][0][1] = ROTATEUPWARDS11(x[0][1][1][0][1]) ^ x[1][1][1][0][0];
		x[0][1][1][1][0] = ROTATEUPWARDS11(x[0][1][1][1][0]) ^ x[1][1][1][1][1];
		x[0][1][1][1][1] = ROTATEUPWARDS11(x[0][1][1][1][1]) ^ x[1][1][1][1][0];
	}
}
